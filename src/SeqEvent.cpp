...
SeqEvent::SeqEvent(SeqTrack* pTrack, ULONG offset, ULONG length, const wchar_t* name, BYTE color)
: VGMItem((VGMFile*)pTrack->parentSeq, offset, length, name, color), parentTrack(pTrack)
{
}
