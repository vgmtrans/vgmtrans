...
SeqSlider<TNumber>::SeqSlider(SeqTrack *track, uint32_t time, uint32_t duration,
...
VolSlider::VolSlider(SeqTrack *track, uint32_t time, uint32_t duration, uint8_t initialValue,
                     uint8_t targetValue)
...
MasterVolSlider::MasterVolSlider(SeqTrack *track, uint32_t time, uint32_t duration,
...
ExpressionSlider::ExpressionSlider(SeqTrack *track, uint32_t time, uint32_t duration,
                                   uint8_t initialValue, uint8_t targetValue)
    : SeqSlider(track, time, duration, initialValue, targetValue) {}
...
PanSlider::PanSlider(SeqTrack *track, uint32_t time, uint32_t duration, uint8_t initialValue,
                     uint8_t targetValue)
    : SeqSlider(track, time, duration, initialValue, targetValue) {}
