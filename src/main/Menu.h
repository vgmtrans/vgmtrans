...
/*#define DECLARE_MENU_CALLS(menuclass, origclass)
   ...
   \
        ...
        virtual bool CallMenuItem(VGMItem* item, int menuItemNum){ return menu.CallMenuItem(item,
   menuItemNum); }
*/
...
#define BEGIN_MENU_SUB(origclass, parentclass)                                                   \
   ...
   public:                                                                                       \
    ...
    template <class T>                                                                           \
    class origclassMenu : public parentclass::origclassMenu<T> {                                 \
       public:                                                                                   \
        origclassMenu() {
#define BEGIN_MENU(origclass)                                                                    \
   ...
   public:                                                                                       \
    ...
    template <class T>                                                                           \
    class origclassMenu : public Menu<T> {                                                       \
       public:                                                                                   \
        origclassMenu() {
