...
*/
const wchar_t *NDS2SFLoader::psf_read_exe(RawFile *file, unsigned char *&exebuffer,
...
const wchar_t *NDS2SFLoader::load_psf_libs(PSFFile &psf, RawFile *file, unsigned char *&exebuffer,
                                           size_t &exebuffersize) {
    char libTagName[16];
    int libIndex = 1;
    while (true) {
