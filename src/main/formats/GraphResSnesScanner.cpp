...
// 0585: fc        inc   y
// 0586: fc        inc   y
BytePattern GraphResSnesScanner::ptnDspRegInit("\x8d\x00\xf6\xd0\x05\x5d\xf6\xcf"
...
void GraphResSnesScanner::SearchForGraphResSnesFromARAM(RawFile *file) {
    ...
    // scan SRCN table
    GraphResSnesInstrSet *newInstrSet =
        new GraphResSnesInstrSet(file, version, spcDirAddr, newSeq->instrADSRHints);
