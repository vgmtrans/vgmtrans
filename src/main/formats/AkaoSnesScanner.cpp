...
BytePattern AkaoSnesScanner::ptnReadNoteLengthV1("\xcd\x0f\x8d\x00\x9e\xf8\x27\xf6"
                                                 "\xb1\x18",
                                                 "xxxxxx?x"
                                                 "??",
                                                 10);
...
BytePattern AkaoSnesScanner::ptnReadNoteLengthV2("\x8d\x00\xcd\x0f\x9e\xf8\x06\xf6"
                                                 "\xf4\x19",
                                                 "xxxxxx?x"
                                                 "??",
                                                 10);
...
BytePattern AkaoSnesScanner::ptnReadNoteLengthV4("\xcd\x0e\x9e\xf8\xa2\xf6\xaa\x16", "xxxx?x??", 8);
...
// 0c83: f0 0a     beq   $0c8f
BytePattern AkaoSnesScanner::ptnVCmdExecFF4("\xa8\xd2\x1c\xfd\xf6\xee\x17\x2d"
...
// 0744: d0 01     bne   $0747
BytePattern AkaoSnesScanner::ptnVCmdExecRS3("\xa8\xc4\xc4\xa6\x1c\xfd\xf6\x56"
...
BytePattern AkaoSnesScanner::ptnReadSeqHeaderV1("\x8d\x01\xcb\x8d\xcd\x00\xf5\x00"
...
BytePattern AkaoSnesScanner::ptnReadSeqHeaderV2("\xcd\x00\x8d\x00\x8f\x01\x93\xf5"
...
BytePattern AkaoSnesScanner::ptnReadSeqHeaderFFMQ("\xcd\x10\xf5\xff\x1b\xd4\x0d\x1d"
...
BytePattern AkaoSnesScanner::ptnReadSeqHeaderV4("\xe5\x00\x1c\xc4\x00\xe5\x01\x1c"
...
BytePattern AkaoSnesScanner::ptnLoadDIRV1("\xe8\x1e\x8d\x5d\x3f\xe9\x10", "x?xxx??", 7);

//; Final Fantasy 5 SPC
// 0234: 8d 5d     mov   y,#$5d
// 0236: e8 1b     mov   a,#$1b
// 0238: 3f 55 06  call  $0655
BytePattern AkaoSnesScanner::ptnLoadDIRV3("\x8d\x5d\xe8\x1b\x3f\x55\x06", "xxx?x??", 7);
...
// 0f1d: 6f        ret
BytePattern AkaoSnesScanner::ptnLoadInstrV1("\xd5\xc1\x02\xfd\xf6\x00\xff\xd5"
                                            "\x00\x03\x6f",
                                            "x??xxx?x"
                                            "??x",
                                            11);
...
// 0fd9: f8 06     mov   x,$06
// 0fdb: 6f        ret
BytePattern AkaoSnesScanner::ptnLoadInstrV2("\xd4\xa6\xfd\xf6\x40\x1e\xd5\xa0"
...
BytePattern AkaoSnesScanner::ptnLoadInstrV3("\x1c\xfd\xf6\x00\x1a\xd5\x20\xfb"
...
BytePattern AkaoSnesScanner::ptnReadPercussionTableV4("\x8d\x03\xcf\xfd\xf6\x22\xf1\x30"
...
void AkaoSnesScanner::SearchForAkaoSnesFromARAM(RawFile *file) {
    ...
    if (file->SearchBytePattern(ptnReadSeqHeaderV4, ofsReadSeqHeader)) {
        ...
        addrAPURelocBase =
            (file->GetByte(ofsReadSeqHeader + 13) << 8) | file->GetByte(ofsReadSeqHeader + 11);
        relocatable = true;
    ...
    const uint8_t FF4_VCMD_LEN_TABLE[] = {
        0x03, 0x03, 0x01, 0x02, 0x03, 0x03, 0x03, 0x03, 0x01, 0x01, 0x01, 0x01,
        0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x03, 0x02, 0x03,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    const uint8_t RS1_VCMD_LEN_TABLE[] = {
        0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x03, 0x00, 0x03,
    ...
    const uint8_t FF6_VCMD_LEN_TABLE[] = {
        ...
        0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00,
        0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
        0x02, 0x01, 0x02, 0x01, 0x03, 0x02, 0x02, 0x02, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00};
    const uint8_t FM_VCMD_LEN_TABLE[] = {
        0x01, 0x02, 0x01, 0x02, 0x02, 0x03, 0x00, 0x03, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00,
        0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
        0x02, 0x01, 0x02, 0x01, 0x03, 0x02, 0x02, 0x02, 0x01, 0x03, 0x00, 0x00, 0x01, 0x00, 0x00};
    ...
    const uint8_t GH_VCMD_LEN_TABLE[] = {
        ...
        0x02, 0x01, 0x02, 0x01, 0x03, 0x02, 0x01, 0x01, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    } else if (file->MatchBytes(RS1_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(RS1_VCMD_LEN_TABLE))) {
        minorVersion = AKAOSNES_V2_RS1;
    } else if (file->MatchBytes(FF5_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(FF5_VCMD_LEN_TABLE))) {
        if (minorVersion != AKAOSNES_V3_FFMQ) {
            minorVersion = AKAOSNES_V3_FF5;
        }
    } else if (file->MatchBytes(SD2_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(SD2_VCMD_LEN_TABLE))) {
        minorVersion = AKAOSNES_V3_SD2;
    } else if (file->MatchBytes(RS2_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(RS2_VCMD_LEN_TABLE))) {
        minorVersion = AKAOSNES_V4_RS2;
    } else if (file->MatchBytes(LAL_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(LAL_VCMD_LEN_TABLE))) {
        minorVersion = AKAOSNES_V4_LAL;
    } else if (file->MatchBytes(FF6_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(FF6_VCMD_LEN_TABLE))) {
        minorVersion = AKAOSNES_V4_FF6;
    } else if (file->MatchBytes(FM_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(FM_VCMD_LEN_TABLE))) {
        //; Chrono Trigger SPC
        // 1cf6: 28 0f     and   a,#$0f
        // 1cf8: c4 7b     mov   $7b,a
        // 1cfa: 6f        ret
        BytePattern ptnVCmdF9CT("\x28\x0f\xc4\x7b\x6f", "xxx?x", 5);
    ...
    } else if (file->MatchBytes(RS3_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(RS3_VCMD_LEN_TABLE))) {
        minorVersion = AKAOSNES_V4_RS3;
    } else if (file->MatchBytes(GH_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(GH_VCMD_LEN_TABLE))) {
        minorVersion = AKAOSNES_V4_GH;
    } else if (file->MatchBytes(BSGAME_VCMD_LEN_TABLE, addrVCmdLengthTable,
                                sizeof(BSGAME_VCMD_LEN_TABLE))) {
        minorVersion = AKAOSNES_V4_BSGAME;
    }

    // load sequence
    AkaoSnesSeq *newSeq =
        new AkaoSnesSeq(file, version, minorVersion, addrSeqHeader, addrAPURelocBase, name);
    ...
    AkaoSnesInstrSet *newInstrSet = new AkaoSnesInstrSet(file, version, spcDirAddr, addrTuningTable,
                                                         addrADSRTable, addrPercussionTable);
