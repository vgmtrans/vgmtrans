...
bool FalcomSnesInstrSet::GetInstrPointers() {
    ...
    SNESSampColl *newSampColl =
        new SNESSampColl(FalcomSnesFormat::name, this->rawfile, spcDirAddr, usedSRCNs);
...
FalcomSnesRgn::FalcomSnesRgn(FalcomSnesInstr *instr, FalcomSnesVersion ver, uint32_t offset,
                             uint8_t srcn)
