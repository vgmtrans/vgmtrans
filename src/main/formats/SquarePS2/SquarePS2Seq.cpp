...
bool BGMSeq::GetHeaderInfo() {
  ...
  header->addSimpleChild(dwOffset, 4, "Signature");
  header->addSimpleChild(dwOffset + 0x4, 2, "ID");
  header->addSimpleChild(dwOffset + 0x6, 2, "Associated WD ID");
  header->addSimpleChild(dwOffset + 0x8, 1, "Number of Tracks");
  header->addSimpleChild(dwOffset + 0xE, 2, "PPQN");
  header->addSimpleChild(dwOffset + 0x10, 4, "File length");
