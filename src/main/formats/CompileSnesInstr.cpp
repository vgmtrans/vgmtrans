...
CompileSnesInstrSet::CompileSnesInstrSet(RawFile* file, CompileSnesVersion ver, uint16_t addrTuningTable, uint16_t addrPitchTablePtrs, uint32_t spcDirAddr, const std::wstring & name) :
...
bool CompileSnesInstrSet::GetInstrPointers()
{
	...
	for (uint8_t srcn = 0; srcn <= 0x3f; srcn++)
	{
		...
		CompileSnesInstr * newInstr = new CompileSnesInstr(this, version, ofsInstrEntry, addrPitchTablePtrs, srcn, spcDirAddr, instrName.str());
...
CompileSnesInstr::CompileSnesInstr(VGMInstrSet* instrSet, CompileSnesVersion ver, uint16_t addrTuningTableItem, uint16_t addrPitchTablePtrs, uint8_t srcn, uint32_t spcDirAddr, const std::wstring& name) :
...
CompileSnesRgn::CompileSnesRgn(CompileSnesInstr* instr, CompileSnesVersion ver, uint16_t addrTuningTableItem, uint16_t addrPitchTablePtrs, uint8_t srcn, uint32_t spcDirAddr) :
