...
PandoraBoxSnesInstrSet::PandoraBoxSnesInstrSet(RawFile* file, PandoraBoxSnesVersion ver, uint32_t spcDirAddr, uint16_t addrLocalInstrTable, uint16_t addrGlobalInstrTable, uint8_t globalInstrumentCount, const std::map<uint8_t, uint16_t> & instrADSRHints, const std::wstring & name) :
...
bool PandoraBoxSnesInstrSet::GetInstrPointers()
{
	...
	for (uint8_t instrNum = 0; instrNum <= 0x7f; instrNum++) {
		...
		PandoraBoxSnesInstr * newInstr = new PandoraBoxSnesInstr(this, version, addrLocalInstrItem, instrNum, srcn, spcDirAddr, adsr, instrName.str());
...
PandoraBoxSnesInstr::PandoraBoxSnesInstr(VGMInstrSet* instrSet, PandoraBoxSnesVersion ver, uint32_t offset, uint8_t theInstrNum, uint8_t srcn, uint32_t spcDirAddr, uint16_t adsr, const std::wstring& name) :
...
PandoraBoxSnesRgn::PandoraBoxSnesRgn(PandoraBoxSnesInstr* instr, PandoraBoxSnesVersion ver, uint32_t offset, uint8_t srcn, uint32_t spcDirAddr, uint16_t adsr) :
