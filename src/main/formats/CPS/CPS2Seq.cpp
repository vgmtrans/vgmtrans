...
CPS2Seq::CPS2Seq(RawFile *file, uint32_t offset, CPS2FormatVer fmtVersion, std::string name, std::vector<int8_t> instrTransposeTable)
...
int8_t CPS2Seq::transposeForInstr(uint8_t instrIndex) {
