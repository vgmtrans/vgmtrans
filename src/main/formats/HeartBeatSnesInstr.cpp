...
bool HeartBeatSnesInstrSet::GetInstrPointers() {
    ...
    SNESSampColl *newSampColl =
        new SNESSampColl(HeartBeatSnesFormat::name, this->rawfile, spcDirAddr, usedSRCNs);
...
HeartBeatSnesRgn::HeartBeatSnesRgn(HeartBeatSnesInstr *instr, HeartBeatSnesVersion ver,
                                   uint32_t offset)
