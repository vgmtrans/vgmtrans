...
class TriAcePS1InstrSet : public VGMInstrSet {
   public:
...
class TriAcePS1Instr : public VGMInstr {
   public:
    typedef struct _RgnInfo {
        uint8_t
            note_range_low;  // These ranges only seem to kick in when the instr has more than 1 rgn
   ...
   public:
    TriAcePS1Instr(VGMInstrSet *instrSet, uint32_t offset, uint32_t length, uint32_t theBank,
