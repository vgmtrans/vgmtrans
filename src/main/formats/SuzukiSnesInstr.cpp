...
SuzukiSnesInstrSet::SuzukiSnesInstrSet(RawFile *file, SuzukiSnesVersion ver, uint32_t spcDirAddr,
...
bool SuzukiSnesInstrSet::GetInstrPointers() {
    ...
    SNESSampColl *newSampColl =
        new SNESSampColl(SuzukiSnesFormat::name, this->rawfile, spcDirAddr, usedSRCNs);
...
SuzukiSnesInstr::SuzukiSnesInstr(VGMInstrSet *instrSet, SuzukiSnesVersion ver, uint8_t instrNum,
...
bool SuzukiSnesInstr::LoadInstr() {
    ...
    SuzukiSnesRgn *rgn = new SuzukiSnesRgn(this, version, instrNum, spcDirAddr, addrSRCNTable,
...
SuzukiSnesRgn::SuzukiSnesRgn(SuzukiSnesInstr *instr, SuzukiSnesVersion ver, uint8_t instrNum,
