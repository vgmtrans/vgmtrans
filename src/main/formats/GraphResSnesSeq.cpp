...
bool GraphResSnesTrack::ReadEvent(void) {
    ...
    switch (eventType) {
        ...
        case EVENT_LOOP_START: {
            AddGenericEvent(beginOffset, curOffset - beginOffset, L"", desc.str(), CLR_LOOP,
                            ICON_STARTREP);
        ...
        case EVENT_NOISE_TOGGLE: {
            AddGenericEvent(beginOffset, curOffset - beginOffset, L"Noise On/Off", desc.str(),
        ...
        case EVENT_MASTER_VOLUME_FADE: {
            ...
            AddGenericEvent(beginOffset, curOffset - beginOffset, L"Master Volume Fade", desc.str(),
        ...
        case EVENT_ADSR: {
            ...
            desc << L"ADSR: " << std::hex << std::setfill(L'0') << std::setw(4) << std::uppercase
                 << (int)newADSR;
        ...
        case EVENT_RET: {
            AddGenericEvent(beginOffset, curOffset - beginOffset, L"End Pattern", desc.str(),
                            CLR_LOOP, ICON_ENDREP);
        ...
        case EVENT_DEFAULT_LENGTH: {
            ...
            AddGenericEvent(beginOffset, curOffset - beginOffset, L"Default Note Length",
        ...
        default:
            ...
            pRoot->AddLogItem(new LogItem((std::wstring(L"Unknown Event - ") + desc.str()).c_str(),
                                          LOG_LEVEL_ERR, L"GraphResSnesSeq"));
            bContinue = false;
            break;
    }
