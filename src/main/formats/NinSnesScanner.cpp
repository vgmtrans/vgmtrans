...
// 081a: 2f b9     bra   $07d5
BytePattern NinSnesScanner::ptnBranchForVcmd("\x68\xe0\x90\x05\x3f\x95\x08\x2f"
                                             "\xb9",
                                             "x?xxx??x"
                                             "?",
                                             9);
...
BytePattern NinSnesScanner::ptnBranchForVcmdReadahead("\x68\xef\xf0\x29\x68\xe0\x90\x30"
...
BytePattern NinSnesScanner::ptnJumpToVcmd("\x1c\xfd\xf6\x9d\x0a\x2d\xf6\x9c"
...
BytePattern NinSnesScanner::ptnJumpToVcmdSMW("\x1c\x5d\xe8\x00\x1f\xdc\x0e", "xxxxx??", 7);
...
// 10ce: fd        mov   y,a
// 10cf: 2f e3     bra   $10b4
BytePattern NinSnesScanner::ptnReadVcmdLengthSMW("\x68\xda\x90\x0a\x6d\xfd\xae\x60"
...
BytePattern NinSnesScanner::ptnDispatchNoteYI("\x2d\x9f\x28\x07\xfd\xf6\xe8\x3f"
...
// 06e2: fd        mov   y,a
// 06e3: ae        pop   a
BytePattern NinSnesScanner::ptnIncSectionPtr("\x8d\x00\xf7\x40\x3a\x40\x2d\xf7"
                                             "\x40\x3a\x40\xfd\xae",
                                             "xxx?x?xx"
                                             "?x?xx",
                                             13);
...
BytePattern NinSnesScanner::ptnLoadInstrTableAddress("\x8d\x06\xcf\xda\x10\x60\x98\x00"
                                                     "\x10\x98\x05\x11",
                                                     "xxxx?xx?"
                                                     "?x??",
                                                     12);
...
BytePattern NinSnesScanner::ptnLoadInstrTableAddressSMW("\x8d\x05\x8f\x46\x14\x8f\x5f\x15"
                                                        "\xcf\x7a\x14\xda\x14",
                                                        "xxx??x??"
                                                        "xx?x?",
                                                        13);
...
BytePattern NinSnesScanner::ptnSetDIR("\x8f\x5d\xf2\x8f\x03\xf3", "xxxx?x", 6);

//; Yoshi's Island SPC
// 042c: e8 3c     mov   a,#$3c
// 042e: 8d 5d     mov   y,#$5d
// 0430: 3f fa 05  call  $05fa             ; source dir = $3c00
BytePattern NinSnesScanner::ptnSetDIRYI("\xe8\x3c\x8d\x5d\x3f\xfa\x05", "x?xxx??", 7);

//; Super Mario World SPC
//; default values for DSP regs
// 1295: db $7f,$7f,$00,$00,$2f,$60,$00,$00,$00,$80,$60,$02
// 12a1: db $0c,$1c,$2c,$3c,$6c,$0d,$2d,$3d,$4d,$5d,$6d,$7d
BytePattern NinSnesScanner::ptnSetDIRSMW("\x7f\x7f\x00\x00\x2f\x60\x00\x00\x00\x80\x60\x02"
...
BytePattern NinSnesScanner::ptnIncSectionPtrGD3("\x8d\x00\xf7\x40\x3a\x40\x2d\xf7"
...
BytePattern NinSnesScanner::ptnIncSectionPtrYSFR("\x8d\x00\xf7\x4c\xc4\x00\xc4\x4e"
...
BytePattern NinSnesScanner::ptnIncSectionPtrYs4("\x8d\x00\xf7\x35\x0d\x3a\x35\x2d"
...
// 09d2: ee        pop   y
BytePattern NinSnesScanner::ptnInitSectionPtrHE4("\x6d\xc4\x8c\x8f\x20\x8d\x60\x84"
...
// 07df: fd        mov   y,a
// 07e0: f0 03     beq   $07e5
BytePattern NinSnesScanner::ptnJumpToVcmdCTOW("\x80\xa8\xe0\x1c\xfd\xf6\x6d\x07"
...
// 10d9: 2d        push  a
// 10da: 6f        ret
BytePattern NinSnesScanner::ptnJumpToVcmdYSFR("\x28\x1f\x1c\xfd\xf6\xdc\x10\x2d"
                                              "\xf6\xdb\x10\x2d\x6f",
                                              "xxxxx??x"
                                              "x??xx",
                                              13);
...
// 0be4: 2d        push  a
// 0be5: 6f        ret
BytePattern NinSnesScanner::ptnJumpToVcmdYs4("\x80\xa8\xe0\x1c\xfd\xf6\x47\x06"
...
BytePattern NinSnesScanner::ptnReadVcmdLengthYSFR("\x80\xa8\xe0\xcb\x00\xfd\xf6\xeb"
                                                  "\x0b",
                                                  "xx?x?xx?"
                                                  "?",
                                                  9);
...
BytePattern NinSnesScanner::ptnReadVcmdLengthYs4("\x68\xe0\x90\x0e\x6d\xfd\xae\x80"
                                                 "\x96\x17\x0c",
                                                 "x?x?xxxx"
                                                 "x??",
                                                 11);
...
BytePattern NinSnesScanner::ptnDispatchNoteGD3("\x2d\x9f\x28\x07\xfd\xf6\xe5\x10"
                                               "\xd5\x01\x02\xae\x28\x0f\xfd\xf6"
...
BytePattern NinSnesScanner::ptnDispatchNoteYSFR("\x28\x0f\xfd\xf6\x0b\x0c\xd5\x90"
...
BytePattern NinSnesScanner::ptnDispatchNoteLEM("\x30\x1e\xd5\x00\x02\x3f\x85\x0b"
...
BytePattern NinSnesScanner::ptnDispatchNoteFE3("\x68\x40\xb0\x0c\x28\x3f\xfd\xf6"
...
BytePattern NinSnesScanner::ptnDispatchNoteFE4("\x01\x30\x13\x68\x40\x28\x3f\xfd"
...
BytePattern NinSnesScanner::ptnDispatchNoteYs4("\x2d\x9f\x28\x07\xfd\xf6\xc9\x17"
...
// 0e15: 6f        ret
BytePattern NinSnesScanner::ptnWriteVolumeKSS("\x3f\x16\x0e\xd4\xd0\x8d\x14\xe8"
...
BytePattern NinSnesScanner::ptnRD1VCmd_FA_FE("\xc4\x5f\x6f\x3f\xf1\x18\x6f\xbc"
...
BytePattern NinSnesScanner::ptnRD2VCmdInstrADSR("\x2d\x8d\x06\xcf\xda\x14\x60\x98"
...
// 0898: bb 23     inc   $23+x
// 089a: 6f        ret
BytePattern NinSnesScanner::ptnIntelliVCmdFA("\x30\xdd\xf4\x22\xc4\xb6\xf4\x23"
...
// 0ab3: ae        pop   a
BytePattern NinSnesScanner::ptnInstrVCmdGD3("\xd5\x11\x02\xfd\x30\x15\x2d\x4d"
...
BytePattern NinSnesScanner::ptnLoadInstrTableAddressSOS("\x8f\x00\x00\x8f\x3e\x01\x68\x00"
...
BytePattern NinSnesScanner::ptnLoadInstrTableAddressCTOW("\x2d\x78\x00\x04\xd0\x08\x8f\x00"
...
BytePattern NinSnesScanner::ptnLoadInstrTableAddressYSFR("\x8d\x5d\xe8\x1b\xc4\x45\x3f\x99"
...
BytePattern NinSnesScanner::ptnSetDIRCTOW("\x8d\x5d\xe8\x3a\x3f\x0b\x05", "xxx?x??", 7);

//; Terranigma SPC
// 0335: e8 0f     mov   a,#$0f
// 0337: 8d 5d     mov   y,#$5d
// 0339: 4f 1e     pcall $1e               ; set DIR to $0f00
BytePattern NinSnesScanner::ptnSetDIRTS("\xe8\x0f\x8d\x5d\x4f\x1e", "x?xxx?", 6);
...
BytePattern NinSnesScanner::ptnInstrVCmdACTR("\xd5\x15\x02\xeb\x34\xd0\x0f\xfd"
...
// 08af: 60        clrc
// 08b0: 84 39     adc   a,$39
BytePattern NinSnesScanner::ptnInstrVCmdACTR2("\xd5\x15\x02\xeb\x34\xd0\x11\xfd"
                                              "\x10\x06\x80\xa8\xca\x60\x84\x5f"
...
BytePattern NinSnesScanner::ptnInstrVCmdTS("\xd5\x17\x02\xd0\x12\xfd\x10\x07"
...
void NinSnesScanner::SearchForNinSnesFromARAM(RawFile *file) {
    ...
    char ptnInitSectionPtrBytes[] = "\xf5\xff\x38\xfd\xf5\xfe\x38\xda"
                                    "\x30";
    ptnInitSectionPtrBytes[8] = addrSectionPtr;
    BytePattern ptnInitSectionPtr(ptnInitSectionPtrBytes,
                                  "x??xx??x"
                                  "x",
                                  9);
    ...
    char ptnInitSectionPtrBytesYI[] = "\x1c\x5d\xf5\x8f\xff\xfd\xd0\x03"
                                      "\xc4\x04\x6f\xf5\x8e\xff\xda\x40";
    ptnInitSectionPtrBytesYI[15] = addrSectionPtr;
    BytePattern ptnInitSectionPtrYI(ptnInitSectionPtrBytesYI,
                                    "xxx??xxx"
                                    "x?xx??xx",
                                    16);
    ...
    // 0b69: c4 41     mov   $41,a
    char ptnInitSectionPtrBytesSMW[] = "\x1c\xfd\xf6\x5e\x13\xc4\x40\xf6"
                                       "\x5f\x13\xc4\x41";
    ptnInitSectionPtrBytesSMW[6] = addrSectionPtr;
    ptnInitSectionPtrBytesSMW[11] = addrSectionPtr + 1;
    BytePattern ptnInitSectionPtrSMW(ptnInitSectionPtrBytesSMW,
                                     "xxx??xxx"
                                     "??xx",
                                     12);
    ...
    char ptnInitSectionPtrBytesGD3[] = "\x5d\xf5\xfc\x11\xf0\xee\xfd\xf5"
                                       "\xfb\x11\xda\x40";
    ptnInitSectionPtrBytesGD3[11] = addrSectionPtr;
    BytePattern ptnInitSectionPtrGD3(ptnInitSectionPtrBytesGD3,
                                     "xx??x?xx"
                                     "??xx",
                                     12);
    ...
    // 1490: c4 4d     mov   $4d,a
    char ptnInitSectionPtrBytesYSFR[] = "\xfd\xf7\x48\xc4\x4c\xfc\xf7\x48"
                                        "\xc4\x4d";
    ptnInitSectionPtrBytesYSFR[4] = addrSectionPtr;
    ptnInitSectionPtrBytesYSFR[9] = addrSectionPtr + 1;
    BytePattern ptnInitSectionPtrYSFR(ptnInitSectionPtrBytesYSFR,
                                      "xx?xxxx?"
                                      "xx",
                                      10);
    ...
    char ptnInitSectionPtrBytesTS[] = "\xe5\xfc\x10\xec\xfd\x10\xda\x23"
                                      "\x3a\x23\x3a\x23";
    ...
    BytePattern ptnInitSectionPtrTS(ptnInitSectionPtrBytesTS,
                                    "x??x??xx"
                                    "xxxx",
                                    12);
    ...
    char ptnInitSectionPtrBytesYs4[] = "\xf5\xb9\x06\xfd\xf5\xb8\x06\xda"
                                       "\x35\x2d\xdd\x80\xa8\xd0\xfd\xae"
                                       "\xda\x17";
    ptnInitSectionPtrBytesYs4[8] = addrSectionPtr;
    BytePattern ptnInitSectionPtrYs4(ptnInitSectionPtrBytesYs4,
                                     "x??xx??x"
                                     "xxxxx?xx"
                                     "xx",
                                     18);
    ...
    // DERIVED VERSIONS
        ...
        char ptnInitSongListPtrBytesYSFR[] = "\x8f\x00\x48\x8f\x1e\x49";
        ptnInitSongListPtrBytesYSFR[2] = addrSongListPtr;
        ptnInitSongListPtrBytesYSFR[5] = addrSongListPtr + 1;
        BytePattern ptnInitSongListPtrYSFR(ptnInitSongListPtrBytesYSFR, "x?xx?x", 6);

        uint32_t ofsInitSongListPtr;
        if (file->SearchBytePattern(ptnInitSongListPtrYSFR, ofsInitSongListPtr)) {
            addrSongList = file->GetByte(ofsInitSongListPtr + 1) |
                           (file->GetByte(ofsInitSongListPtr + 4) << 8);
        }
    } else {
        return;
    }
    ...
    if (file->SearchBytePattern(ptnJumpToVcmdYSFR, ofsBranchForVcmd)) {
        ...
        if (file->SearchBytePattern(ptnBranchForVcmdReadahead, ofsBranchForVcmd)) {
            ...
            // this search often finds a wrong code, but some games still need it (for example,
            // Human games)
        ...
        if (file->SearchBytePattern(ptnJumpToVcmd, ofsJumpToVcmd)) {
            addrVoiceCmdAddressTable =
                file->GetShort(ofsJumpToVcmd + 7) + ((firstVoiceCmd * 2) & 0xff);
            ...
            if (file->SearchBytePattern(ptnReadVcmdLengthSMW, ofsReadVcmdLength)) {
                addrVoiceCmdAddressTable =
                    file->GetShort(ofsJumpToVcmd + 5) + ((firstVoiceCmd * 2) & 0xff);
                addrVoiceCmdLengthTable = file->GetShort(ofsReadVcmdLength + 9) + firstVoiceCmd;
    ...
    if (version == NINSNES_STANDARD) {
        if (konamiBaseAddress != 0xffff) {
            ...
            if (firstVoiceCmd == 0xe0 &&
                file->MatchBytes(STD_VCMD_LEN_TABLE, addrVoiceCmdLengthTable,
                                 sizeof(STD_VCMD_LEN_TABLE))) {
                if (addrVoiceCmdAddressTable + sizeof(STD_VCMD_LEN_TABLE) * 2 ==
                    ...
                    } else if (file->SearchBytePattern(ptnInstrVCmdTS, ofsInstrVCmd) &&
                               numOfVoiceCmd == 32 &&
                               file->GetByte(addrVoiceCmdLengthTable + 31) == 1) {
                ...
                if (file->SearchBytePattern(ptnIntelliVCmdFA, ofsIntelliVCmdFA)) {
                    ...
                    if (file->SearchBytePattern(ptnDispatchNoteFE3, ofsDispatchNote)) {
                        const uint8_t INTELLI_FE3_VCMD_LEN_TABLE[40] = {
                            0x01, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x01, 0x02, 0x01,
                            0x01, 0x03, 0x00, 0x01, 0x02, 0x03, 0x01, 0x03, 0x03, 0x00,
                            0x01, 0x03, 0x00, 0x03, 0x03, 0x03, 0x01, 0x00, 0x00, 0x00,
                            0x00, 0x01, 0x01, 0x01, 0x01, 0x00, 0x01, 0x01, 0x02, 0x02};
                        if (firstVoiceCmd == 0xd6 &&
                            file->MatchBytes(INTELLI_FE3_VCMD_LEN_TABLE, addrVoiceCmdLengthTable,
                        ...
                        if (firstVoiceCmd == 0xda &&
                            file->MatchBytes(INTELLI_FE4_VCMD_LEN_TABLE, addrVoiceCmdLengthTable,
                        ...
                        if (firstVoiceCmd == 0xda &&
                            file->MatchBytes(INTELLI_TA_VCMD_LEN_TABLE, addrVoiceCmdLengthTable,
    ...
    NinSnesSeq *newSeq =
        new NinSnesSeq(file, version, addrSongStart, 0, volumeTable, durRateTable, name);
    ...
    if (file->SearchBytePattern(ptnLoadInstrTableAddress, ofsLoadInstrTableAddressASM)) {
        addrInstrTable = file->GetByte(ofsLoadInstrTableAddressASM + 7) |
                         (file->GetByte(ofsLoadInstrTableAddressASM + 10) << 8);
    } else if (file->SearchBytePattern(ptnLoadInstrTableAddressSMW, ofsLoadInstrTableAddressASM)) {
        addrInstrTable = file->GetByte(ofsLoadInstrTableAddressASM + 3) |
                         (file->GetByte(ofsLoadInstrTableAddressASM + 6) << 8);
    }
    // DERIVED VERSIONS
        ...
        if (file->SearchBytePattern(ptnLoadInstrTableAddressCTOW, ofsLoadInstrTableAddressASM)) {
            ...
            addrInstrTable = file->GetByte(ofsLoadInstrTableAddressASM + 1) |
                             (file->GetByte(ofsLoadInstrTableAddressASM + 4) << 8);
        } else {
            return;
        }
        ...
        if (file->SearchBytePattern(ptnLoadInstrTableAddressYSFR, ofsLoadInstrTableAddressASM)) {
            ...
            addrInstrTable = file->GetByte(ofsLoadInstrTableAddressASM + 10) |
                             (file->GetByte(ofsLoadInstrTableAddressASM + 13) << 8);
        } else {
            return;
        }
    } else {
