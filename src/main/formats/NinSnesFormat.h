...
enum NinSnesVersion {
    ...
    NINSNES_KONAMI,    // Old Konami games (e.g. Gradius III, Castlevania IV, Legend of the Mystical
                       // Ninja)
...
static inline bool IsQuintetVersion(NinSnesVersion version) {
    return version == NINSNES_QUINTET_ACTR || version == NINSNES_QUINTET_ACTR2 ||
           version == NINSNES_QUINTET_IOG || version == NINSNES_QUINTET_TS;
}
END_FORMAT()
