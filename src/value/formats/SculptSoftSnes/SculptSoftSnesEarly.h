...
[[nodiscard]] core::TrackProgram decodeEarlyTrack(const core::TrackDecodeScope& scope, const Layout& layout, u32 number,
                                                  u32 start, std::vector<core::Diagnostic>* diagnostics,
                                                  std::set<u8>* referencedPrograms);
[[nodiscard]] core::SequenceRuntime makeEarlyRuntime(RuntimeConfig config);
