...
void registerValueFormats(core::Session& session, const ValueFormatOptions& options) {
  ...
  session.registerFormat(graph_res_snes::module());
  session.registerFormat(heartbeat_ps1::heartBeatPs1Module());
  ...
  session.registerFormat(konami_ps1::konamiPs1Module());
  ...
  session.registerFormat(mori_snes::module());
  ...
  session.registerFormat(softcreat_snes::module());
