...
struct Cps1SynthAvailability {
  bool ym2151 = false;
  bool oki = false;
};

[[nodiscard]] Cps1SynthAvailability addCps1Synth(core::ScanResultBuilder& builder,
                                                 core::ScanInstrumentSetRef ymInstrumentSet,
                                                 core::ScanInstrumentSetRef okiInstrumentSet,
                                                 core::ScanSampleCollectionRef sampleCollection, CpsLayout& layout);
[[nodiscard]] bool addCpsQSoundSynth(core::ScanResultBuilder& builder, core::ScanInstrumentSetRef instrumentSet,
                                     core::ScanSampleCollectionRef sampleCollection, const CpsLayout& layout);
