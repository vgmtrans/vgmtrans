...
bool QHexMetadata::hasMetadata(int line) const {
...
void QHexMetadata::metadata(int line, int start, int length, const QColor &fgcolor,
                            const QColor &bgcolor, const QString &comment) {
    this->setMetadata({line, start, length, fgcolor, bgcolor, comment});
}

void QHexMetadata::color(int line, int start, int length, const QColor &fgcolor,
