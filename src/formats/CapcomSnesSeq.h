...
{
public:
	CapcomSnesSeq(RawFile* file, CapcomSnesVersion ver, uint32_t seqdata_offset, bool priorityInHeader, std::wstring newName = L"Capcom SNES Seq");
